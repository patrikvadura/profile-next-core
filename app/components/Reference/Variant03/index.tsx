...
export function ReferenceVariant03({ layout, align, breakpoint, preview }: ReferenceVariantProps) {
  ...
  return (
    <div
      ...
      className={getBreakpointStyles(
        `${layoutsClass} relative w-full lg:min-h-screen py-12 md:py-24 overflow-hidden`,
        breakpoint,
        preview,
      )}
    >
      <div
        className={getBreakpointStyles(
          'items-center md:items-center text-center md:text-center container lg:min-h-[650px] flex flex-col justify-center',
          breakpoint,
          preview,
        )}
      >
