...
const ColorPickerContact: React.FC<ColorPickerProps> = ({
  backgroundColor,
  accentBgColor,
  accentFgColor,
  typoColor,
}) => {
  const [backgroundColorValue, setBackgroundColor] = useState(colors.contact.background)
  const [accentBgColorValue, setAccentBgColor] = useState(colors.contact.accent.background)
  const [accentFgColorValue, setAccentFgColor] = useState(colors.contact.accent.foreground)
  const [typoColorValue, setTypoColor] = useState(colors.contact.typo)
...
export default ColorPickerContact
